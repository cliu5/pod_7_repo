...
print('Question 2')
#simply use print command in front of function
...
print('Question 5')
add_song(my_playlist, {'artist': 'Prince', 'title': 'Purple rain'})
add_song(my_playlist, {'artist': 'Prince', 'title': '1999'})
...
print('Question 6')
print(get_playlist_legnth(my_playlist))
import numpy as np
