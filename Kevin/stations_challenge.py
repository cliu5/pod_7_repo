...
lines: ['1', '2', '3', 'L']
'''
tv_station = SubwayStation('14th streer',location='14th street and 7th avenue', lines=['1', '2', '3', 'L'])
tv_station.show_info()
...
class BusStation(Station):
    ...
    def closed_station(self): 
        self.open=False
    def show_info(self):
            print(f' {self.station_name}, {self.location}, {self.routes}, {self.open}')
        


#

bus_station = BusStation(station_name ='NYC Megabus stop', location ='34th street and 12th avenue', routes = ['Boston', "DC", 'Philly'], open = False)
