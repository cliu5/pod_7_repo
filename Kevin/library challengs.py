python # You are working on a library management system, here are the list books at the library
...
​type
​# The object book is type list
print(type(books))
# 1.1
# Create a function b'available_books' to print the books list
def available_books():
    print(books)
# Parameters: Not needed for this function
# Return: Not needed for this function
def function (PAREMETERSGO HERE)
dEFINE A VARIABLE
X = 5
MY_BOOKS = books#LEFT_HAND_NAME = RIGHT_HAND_NAME
​
# 1.2
