...
print(f"In the 2020 NBA playoffs, Jamal Murry made {jamal_murray_3pts_made} 3 point shots and {JM_3attempt} 3 point shot attempts.")
print(f"In the 2020 NBA playoffs, Fred VanVleet made {FV_3made} 3 point shots and {FV_3attempt}  3 point shots attempts.")
...
# TODO: Calculate and print the 3 point playoffs, percentage for Jamal Murray
print(f"Jamal Murray's 3point percentage in the 2020 NBA playoffs was {JM_3point_percentage}")

# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(f"Fred Vanvleet's 3 point percentage in the 2020 NBA playoff was {FV_3point_percentage}")

# TODO: Calculate and print the 3 point percentage for James Harden{JM_3point}
print(f"James Harden's 3 point percentage in the 2020 NBA playoff was {JM_3point_percentage}")

print('Challenge 3.1: Print out the paragraph but with only 1 sentence per line')
# TODO: Print the giant chunk of text out using escape characters so each sentence comes out on a new line

print('The lakers went all in this off season and swung a deal for former Pelican forward Anthony Davis.\
\nThey sent a package of Brandon Ingram, Lonzo Ball, Josh Hart, and 3 first-round picks to New Orleans to land Davis. \
\nThose three have made good development with the pelicans, especially Brandom Ingram. \
\nBut, the deal is still a hugh win for the Lakers as Lebron, Davis,and company have put together an incredible season. \
...
\nDavis proved to the final piece necessary for thr Lakers to rebound from missing the playoffs last year. \
\nLos Angeles wasw a dominant club on both sides of the ball and are in a position to have another sucessful year next season.')

print('Challenge 3.2: Print out the paragraph with only 1 sentence per line')

# TODO: As above, orint out the paragraph with only 1 sentence per line, and all in upper case

text ='The lakers went all in this off season and swung a deal for former Pelican forward Anthony Davis.\
\nThey sent a package of Brandon Ingram, Lonzo Ball, Josh Hart, and 3 first-round picks to New Orleans to land Davis. \
\nThose three have made good development with the pelicans, especially Brandom Ingram. \
\nBut, the deal is still a hugh win for the Lakers as Lebron, Davis,and company have put together an incredible season. \
\nLos Angeles has ridden James and Davis, along with a supporting cast built around them, to the second-best record in the NBA. \
...
\nThey were narrowly behind the Bucks for the best record in the league. \
\nDavis proved to the final piece necessary for thr Lakers to rebound from missing the playoffs last year. \
\nLos Angeles wasw a dominant club on both sides of the ball and are in a position to have another sucessful year' 
# TODO: As above, orint out the paragraph with only 1 sentence per line, and all in upper case
print(text.upper())
...
print(f"The Lakers are the best team is {lakers_are_the_best}. The Seattle Supersonics are the best!")
...
print(int(JM_3point_percentage))
