...
print(f"The value of c ({c}) is True since a ({a}) is greater or equal to b ({b}).")
...
print(f"The value of d ({d}) is False because 5 is not greater than 7 and 8 is indeed less that 20 ")
