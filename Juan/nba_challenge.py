...
chris_weber_3pts_made = 30
Fred_VanVleet_3pts_made = 20
James_Harden_3pts_made = 45
...
print(f"In the 2020 NBA playoffs, Fred Van Vleet made {Fred_VanVleet_3pts_made} 3 point shots")
print(f"In the 2020 NBA playoffs, James Harden made {James_Harden_3pts_made} 3 point shots")
#ODO: Create print statement here for Fred Van Vleet
# TODO: Create print statement here for James Hardenf
print()
