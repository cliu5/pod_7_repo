...
fred_vanvleet_3pts_made = 49
fvv3 = 43
# TODO: Create variable here for number of 3 pt shots made by James Harden
james_harden_3pts_made = 49
jh3 = 37

print("Challenge 2.2:")
print(f"In the 2020 NBA playoffs, Jamal Murray made {jm3} {jamal_murray_3pts_made} 3 point shots")
# TODO: Create print statement here for Fred VanVleet
print(f"In the 2020 NBA playoffs, Fred VanVleet made {fvv3} {fred_vanvleet_3pts_made} 3 point shots")
# TODO: Create print statement here for James Harden
print(f"In the 2020 NBA playoffs, James Harden made {jh3} {james_harden_3pts_made} 3 point shots")
print()
...
print(f"In the 2020 NBA playoffs, Jamal Murray made {jm3} {jamal_murray_3pts_made} 3 point shots and {jm3} shot attempts")
# "In the 2020 NBA playoffs, player X made Y 3 point shots and Z 3 point shot attempts."
print(f"In the 2020 NBA playoffs, Fred VanVleet made {fvv3} {fred_vanvleet_3pts_made} 3 point shots and {jm3} shot attempts")

print(f"In the 2020 NBA playoffs, James Harden made {jh3} {james_harden_3pts_made} 3 point shots and {jh3} shot attempts")
...
print(f"In the 2020 NBA playoffs, Jamal Murray made {jm3} {jamal_murray_3pts_made} 3 points average rate of {jm3 / jm3a} ")
# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(f"In the 2020 NBA playoffs, Fred VanVleet {fvv3} {fred_vanvleet_3pts_made} 3 points average rate of {fvv3 / fvv3a} ")
# TODO: Calculate and print the 3 point percentage for James Harden
print(f"In the 2020 NBA playoffs, James Harden made {jh3} {james_harden_3pts_made} 3 points average rate of {jm3/ jm3a}")
print()
