...
# 1.0
# What data type is the object 'books'? How do you know? list, brackets, verifying through Python
print(type(books))

# 1.1
# Create a function 'available_books' to print the books list
# Parameters: Not needed for this function
# Return: Not needed for this function#  this function does not depend on anything
def available_books():
​    print(book_list)
available_books
# 1.2
...
​def check_out()books_list_remove
# 1.4
# Check out 'SAPIENS' using the check_out function
def check_out(books_list_remove)'SAPIENS'

# Bonus: Run available_books function again to see if the book was checked out
​return_stat[available_books]
# 1.5
# Create a function 'check_in' that adds a book to the books list
# Parameters: book (string)
# Return: Not needed for this function
def check_in add book_list
​
# 1.6
# Check in 'SAPIENS' using the check_in functionj
def check_in 'SAPIENS'
...
# Parameters: book (string)
# Return: Not needed for this function
​def search_by_name = book_list
    if true available 
    print book_list ('AVAILABLE')
# 1.8
