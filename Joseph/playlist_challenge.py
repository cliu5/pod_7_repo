...
'''
my_song1 = {'artist': 'Stevie Ray Vaughan', 'title': 'Supersition'}
...
print('Question 5')
my_song2 = {'artist': 'Funkadelic', 'title': 'Maggot Brain'}
my_song3 = {'artist': 'Pink Floyd', 'title': 'Welcome to the machine'}
...
print(round(np.mean(monthly_plays, 0)))
