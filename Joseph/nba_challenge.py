...
print("Challenge 2.2:")
print(
    f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots")
# TODO: Create print statement here for Fred VanVleet
print(
    f"In the 2020 NBA playoffs, Fred VanVleet made {fred_vanvleet_3pts_made} 3 point shots")
# TODO: Create print statement here for James Harden
print(
    f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made} 3 point shots")
...
print(
    f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots and {jamal_murray_3pts_attempts} 3 point shot attempts.")
print(
    f"In the 2020 NBA playoffs, Jamal Murray made {fred_vanvleet_3pts_made} 3 point shots and {fred_vanvleet_3pts_attempts} 3 point shot attempts.")
print(
    f"In the 2020 NBA playoffs, Jamal Murray made {james_harden_3pts_made} 3 point shots and {james_harden_3pts_attempts} 3 point shot attempts.")
...
print(
    f'The 3 point percentage for Jamal Murray is {jamal_murray_3pts_made/jamal_murray_3pts_attempts}.')
# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(
    f'The 3 point percentage for Fred VanVleet is {fred_vanvleet_3pts_made/jamal_murray_3pts_attempts}.')
# TODO: Calculate and print the 3 point percentage for James Harden
print(
    f'The 3 point percentage for James Harden is {james_harden_3pts_made/jamal_murray_3pts_attempts}.')

print('Challenge 3.1: Print out the paragraph but with only 1 sentence per line')
lakers_paragraph = 'The Lakers went all in this offseason and swung a deal for former Pelicans forward Anthony Davis.\
...
print(
    f'The Lakers are the best is a {str(lakers_are_best).lower()} statement in my opinion.')
...
print(
    f'The 3 point percentage for Jamal Murray is {str(jamal_murray_3pts_made/jamal_murray_3pts_attempts)}.')
print(
    f'The 3 point percentage for Fred VanVleet is {str(fred_vanvleet_3pts_made/jamal_murray_3pts_attempts)}.')
print(
    f'The 3 point percentage for James Harden is {str(james_harden_3pts_made/jamal_murray_3pts_attempts)}.')
# TODO: Take each player's three point percentage (from part 2.5) and convert it to an integer, then print it out.
print(
    f'The 3 point percentage for Jamal Murray is {int((jamal_murray_3pts_made/jamal_murray_3pts_attempts)*100)}.')
print(
    f'The 3 point percentage for Fred VanVleet is {int((fred_vanvleet_3pts_made/jamal_murray_3pts_attempts)*100)}.')
print(
    f'The 3 point percentage for James Harden is {int((james_harden_3pts_made/jamal_murray_3pts_attempts)*100)}.')
# If I didn't multiply by 100 then all of the 3 point percentages would have been 0 as integers'
