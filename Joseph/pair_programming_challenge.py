...
def create_account():
    new_account = {}
    new_account['username'] = input('Enter your username ')
    new_account['password'] = input('Enter your password ')
    new_account['balance'] = float(0.00)
    return new_account
...
deposit(my_account, 101)
print(my_account)
deposit(my_account, 202)
print(my_account)
deposit(my_account, 303)
print(my_account)
...
def withdraw(account, amount):
    if amount <= account['balance']:
        ...
        print(
            f"Insufficient funds, you tried to withdraw ${format(amount, '.2f')} and your current balance is: ${format(account['balance'], '.2f')}")


withdraw(my_account, 55)
print(my_account)
withdraw(my_account, 607)
print(my_account)
withdraw(my_account, 550)
print(my_account)
withdraw(my_account, 1.01)
print(my_account)
