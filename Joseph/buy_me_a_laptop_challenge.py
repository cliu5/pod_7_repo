...
# Challenge 1
pprint("Challenge 1: All possible laptops\n")

pprint("Question 1: You are given a list containing the laptop names. Print the names of each the laptops separately.")
all_laptops = ["Apple MacBook Pro", "Asus Zenbook", "Dell XPS",
               "Lenovo IdeaPad", "Apple MacBook Air", "Sony Viao"]


# TODO: Write code to print all laptop names
pprint("All laptops names:")
pprint('\n'.join(all_laptops))


# Challenge 2

pprint("Challenge 2: Buy a laptop")
pprint("Below is a dictionary of the top 2 laptops of 2020 as reviewed by Tech Crunch. \
...
pprint("Question 2: Out of Stock laptops")
pprint("Suppose that the 13-inch MacBook Pro in space gray color is sold out. Also, the same laptop with 1 TB storage is out of stock as well. Update the list of dictionaries such that these options are removed. Print the updated dictionary.")
...
pprint("Question 3: listing all the prices")
pprint("Time to look at the range of prices. Print out all possible computer prices")

# TODO: print out all possible prices for the laptops
pprint(laptops[0]['types'][0]['price'])
pprint(laptops[0]['types'][1]['price'])
pprint(laptops[1]['types'][0]['price'])
pprint(laptops[1]['types'][1]['price'])
