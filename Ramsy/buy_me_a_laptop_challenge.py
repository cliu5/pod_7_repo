...
print(laptops[0]['types'][1]['price'][0])
print(laptops[0]['types'][1]['price'][1])


# TODO: Write code to print all the color options for Dell XPS 13.
print(laptops[1]['types'][0]['colors'][0])
...
print(laptops[0]['types'][0]['price'][0])
print(laptops[0]['types'][0]['price'][1])
print(laptops[0]['types'][0]['price'][2])

print(laptops[0]['types'][1]['price'][0])
print(laptops[0]['types'][1]['price'][1])

print(laptops[1]['types'][0]['price'][0])
print(laptops[1]['types'][0]['price'][1])
print(laptops[1]['types'][0]['price'][2])
print(laptops[1]['types'][0]['price'][3])

print(laptops[1]['types'][1]['price'][0])
print(laptops[1]['types'][1]['price'][1])
print(laptops[1]['types'][1]['price'][2])
print(laptops[1]['types'][1]['price'][4])
print(laptops[1]['types'][1]['price'][5])