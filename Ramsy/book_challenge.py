...
The function should initialize just 1 attribute, called 'books', as an empty list. No parameters needed, other than self
...
total_books = my_library.count_books()
print(total_books)
...
nyt_bestsellers.add('Billy Summers', 'Stephen King')
