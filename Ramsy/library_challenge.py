...
print(type(books))
#It is a list due to the square brackets. Also, the print statement shows as a list when ran.
...
#It's a list of dictionaries. Each dictionary is a book that includes the details such as title, author, etc. There are curlies within the square brackets.
