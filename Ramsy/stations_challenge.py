...
seattle_subway = SubwayStation(lines = ['1','2','3','L'], 
                               station_name = '14th street',
                               location = '14th street and 7th avenue')
seattle_subway.show_info()
...
class BusStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and travels on {self.routes}')
        if self.open:
            print('Open')
        else:
            print('Closed')
...
'''
example_bus = BusStation(station_name= 'NYC Megabus Stop', location= '34th street and 12th avenue', routes= ['Boston', 'DC', 'Philly'])
example_bus.show_info()
example_bus.open_station()
example_bus.close_station()
example_bus.show_info()
