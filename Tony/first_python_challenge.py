...
#variable box_1 is assigned to the text string "books"
box_1 = 'books'
#variable box_2 is assigned to the text string "clothes"
box_2 = 'clothes'
#variable box_3 is assigned to the text string "plants"
box_3 = 'plants'
#variable box_4 is assigned to the text string "kitchen stuff"
box_4 = 'kitchen stuff'
