...
from playlist_functions import add_song, display_playlist, get_playlist_length, play_track
import numpy as np
...
songToAdd = {'artist' : '3 Doors Down',
            'title'  : 'Here Without You' }

add_song(my_playlist, songToAdd)
...
songToAdd = {'artist' : 'Dax',
            'title'  : 'Self Proclaimed' }
add_song(my_playlist, songToAdd)


songToAdd = {'artist' : 'I Prevail',
            'title'  : 'Blank Space' }
add_song(my_playlist, songToAdd)
