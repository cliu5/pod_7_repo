...
SubwayStation.show_info(station1)
...
class BusStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and stops at lines {self.routes}\n')          
...
station2 = BusStation(station_name='NYC Megabus Stop', location="34th street and 12th avenue", routes=['Boston', 'DC', 'Philly'])


BusStation.show_info(station2)

BusStation.close_station(station2)
