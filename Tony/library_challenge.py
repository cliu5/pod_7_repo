...
#Books is a list. You can tell by the comma separated values within the square brackets, or by printing the type
...
# This is a list of dictionaries. The outmost brackets are square brackets defining a list. 
# The inner entries in the list as the squiggly brackerts, which define dictionaries.
...
def search_by_author(author):
    ...
    for book in books_with_details:
       if author == book.get('author'):
           authorsBooks.append(book.get('title'))
    return authorsBooks
