...
print(sorted(remaining_50_list))
print()
...
setTop = set(top_50_list)
setRemaining = set(remaining_50_list)

setAll = setTop.union(setRemaining)
setClean = setAll - setTop

remaining_50_list = list(setClean)
...
top100 = top_50_list + remaining_50_list
